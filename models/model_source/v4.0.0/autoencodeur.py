...
class AutoEncoder(nn.Module):
    ...
    def __init__(self, input_size:int):
        ...
        self.conv_link_ch1_layer1 = nn.Conv2d(512, 512, kernel_size=(1,1),stride=1, padding=0)
        self.conv_link_ch1_layer2 = nn.Conv2d(512, 256, kernel_size=(1,1),stride=1,padding=0)
        self.conv_link_ch2_layer1 = nn.Conv2d(512, 68, kernel_size=(1,1),stride=1,padding=0)
        self.conv_link_ch2_layer2 = nn.Conv2d(68, 256, kernel_size=(1,1),stride=1,padding=0)


        #self.conv_link_ch2_layers = nn.Sequential(
            #nn.Conv2d(512, 68, kernel_size=(1,1),stride=1,padding=1),
        #    nn.Conv2d(512, 512, kernel_size=(1,1),stride=1,padding=1)
        #)
