...
def startLearning(bs,me,f,p,l):
    ...
    for epoch in range(1,max_epochs+1):  
        ...
        with open("log/training_hourglass5.0.5.log","a") as f:
        ...
        save_checkpoint({
            ...
            'accuracy': val_acc,
            'optimizer' : optimizer.state_dict()}, is_best,"save_model/checkpoint_hourglass5.0.5.pth","save_model/best_model_validation5.0.5.pth")
        is_best = False

        scheduler.step(val_loss)
        
        #Save metrics in a log file
        with open("log/validation_hourglass5.0.5.log","a") as f:
        ...
        if (epoch%5 == 1 or epoch == max_epochs):
            ...
            try:
                send.sendInfos("5 (Hourglass 5.0.5)",desc,loss,acc,loss_lm,"...",loss_expr,"...",val_loss,val_acc,val_loss_lm,"...",val_loss_expr,val_acc)
...
if __name__ == "__main__":
    print(sys.version)
    with open("log/training_hourglass5.0.5.log","w") as f:
        f.close()
    with open("log/validation_hourglass5.0.5.log","w") as f:
        f.close()
